...
import { minusPitca, addPitca, removePitca } from "../redux/slice/cartSlice";
import { useDispatch } from "react-redux";

const PizzaCartItem = ({id, title, type,size, price, imageUrl, count }) => {
    ...
    return (
        <div class="cart__item">
            ...
            <div class="cart__item-count">
                <button onClick={onClickMinus} disabled="" class="button button--outline button--circle cart__item-count-minus">
